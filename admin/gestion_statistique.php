...
// membre mieux notés -------------------------------------------------------
$resultat = executeRequete("SELECT m.prenom, m.nom, m.pseudo,Round(AVG(n.note), 0) FROM note n INNER JOIN membre m ON n.membre_id_auteur = m.id_membre ORDER BY note DESC LIMIT 5"); // on selectionne tout les produits
